...
const oddNumbers = randomNumbers.filter(value => value % 2 !== 0)
...
const numbersLessThan501 = crazyNumbers.filter(value => value < 501).length
...
const oldMovies = tarantinoMovies.filter(obj => obj.release < 2000 ? [obj] : 0)
...
const tvShowsName = tvShows.map(obj => obj.name)
...
const cartName = cart.forEach((obj, index) => {
